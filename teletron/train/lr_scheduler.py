...
class SchedulerMixin:
    ...
    def get_optimizer_for_zero2(self, config: OptimizerConfig, 
        ...
        use_contiguous_gradients = dp_world_size > 1
        reduce_bucket_size = 500000000 if dp_world_size > 1 else 50000000
        allgather_bucket_size = 500000000 if dp_world_size > 1 else 50000000
        optimizer = DeepSpeedZeroOptimizer(
                base_optimizer,
                param_names,
                timers=timers,
                ...
                dynamic_loss_args=None,
                clip_grad=args.clip_grad,
                contiguous_gradients=use_contiguous_gradients,
