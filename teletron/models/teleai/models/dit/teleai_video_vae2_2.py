# Copyright (c) 2025 TeleAI-infra Team and The Alibaba Wan Team Authors. All rights reserved.
...
class TeleaiVideoVAE_2_2(nn.Module):

    def __init__(self, z_dim=48):
        super().__init__()
        ...
        # init model
        self.model = VideoVAE_2_2(z_dim=z_dim).eval().requires_grad_(False)
